...
public class MybatisPlusGenerator {
    ...
    private static final String packageName = "in.ashokit";
    ...
    // 生成的分层代码
    enum LayerType {
        entity("/01-Dummy-WebApp-model"),
        mapper("/01-Dummy-WebApp-dao"),
        mapperxml("/01-Dummy-WebApp-web"),
        service("/01-Dummy-WebApp-service"),
        web("/01-Dummy-WebApp-web"),
        ;
